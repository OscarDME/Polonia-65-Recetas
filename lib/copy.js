...
export const copy = {
  ...
  story: {
    headlinePre: "Cukier to cichy wróg,",
    headlineHighlight: "który niszczy Twoje zdrowie",
    intro:
  ...
  faq: {
    ...
    doesntWorkHeadline: "CO NIE DZIAŁA: ❌",
    doesntWork: [
    ...
    items: [
      ...
      { q: "CZY MOGĘ KORZYSTAĆ Z NICH NA TELEFONIE?", a: "Tak, możesz korzystać z przepisów na telefonie, tablecie lub komputerze." },
      { q: "MASZ WIĘCEJ PYTAŃ?", a: "Tak, w trakcie korzystania z programu możesz zadawać mi wszelkie pytania bezpośrednio." },
      { q: "NA JAK DŁUGO OTRZYMAM DOSTĘP?", a: "Dostęp do całej zawartości otrzymujesz dożywotnio." },
    ],
  },
  ...
  footer: {
    brand: "Crearis",
    copyright: "2026 © Wszelkie prawa zastrzeżone. Zapoznaj się z naszą Polityką prywatności.",
  },
};